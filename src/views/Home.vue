        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-12 col-md d-flex align-items-center">
                    <p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">+254 1234 567</a> or <span
                    ...
                    <div class="social-media">
                        <p class="mb-0 d-flex">
                            <a href="#" class="d-flex align-items-center justify-content-center"><span>
                                <font-awesome-icon :icon="['fab', 'facebook']" /><i class="sr-only">Facebook</i></span></a>
                            <a href="#" class="d-flex align-items-center justify-content-center"><span>
                                <font-awesome-icon :icon="['fab', 'twitter']" /><i class="sr-only">Twitter</i></span></a>
                            <a href="#" class="d-flex align-items-center justify-content-center"><span>
                                <font-awesome-icon :icon="['fab', 'instagram']" /><i class="sr-only">Instagram</i></span></a>
...
<Navbar />
    ...
    <section class="hero-wrap">
        <div class="home-slider owl-carousel js-fullheight ">
					...
					<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
						<div class="col-md-12 ">
							<div class="text w-100 mt-5 text-center">
								<span class="subheading">Taste.it Restaurant</span>
								<h1>Cooking Since</h1>
            ...
            <div class="slider-item js-fullheight" style="background-image: url(/images/bg_6.jpg);">
                <div class="overlay"></div>
                <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
    ...
    <section class="ftco-section ftco-wrap-about ftco-no-pb ftco-no-pt">
        <div class="container">
            <div class="row no-gutters">
                ...
                <div class="col-sm-8 wrap-about py-5  img " style="background-image:url(/images/about.jpg);">
